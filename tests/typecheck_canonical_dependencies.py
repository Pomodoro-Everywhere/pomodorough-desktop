...
def canonical_dependencies_from_store(store: Store) -> CanonicalStorageDependencies:
    ...
    return CanonicalStorageDependencies(
        ...
        _project_canonical_with_pending=store._project_canonical_with_pending,
        _set_canonical_head=store._set_canonical_head_locked,
        _retire_delivery_proof=store._retire_delivery_proof_locked,
        ...
        delivery_proof=store.delivery_proof,
        never_sent_claim=store.never_sent_claim,
        drop_delivery_proof=store._drop_delivery_proof_locked,
    )
