...
```sh
curl -LO https://github.com/Pomodoro-Everywhere/pomodorough-desktop/releases/download/v0.4.4/pomodorough_linux-0.4.4.tar.gz
tar -xzf pomodorough_linux-0.4.4.tar.gz
cd pomodorough_linux-0.4.4
./deploy/install.sh
```
...
```sh
nix profile install github:Pomodoro-Everywhere/pomodorough-desktop/v0.4.4
```
...
```sh
curl -LO https://github.com/Pomodoro-Everywhere/pomodorough-desktop/releases/download/v0.4.4/Pomodorough-0.4.4-x86_64.flatpak
flatpak install --user ./Pomodorough-0.4.4-x86_64.flatpak
