...
```sh
curl -LO https://github.com/Pomodoro-Everywhere/pomodorough-desktop/releases/download/v0.24.0/pomodorough_linux-0.24.0.tar.gz
tar -xzf pomodorough_linux-0.24.0.tar.gz
cd pomodorough_linux-0.24.0
./deploy/install.sh
```
...
```sh
nix profile install github:Pomodoro-Everywhere/pomodorough-desktop/v0.24.0
```
...
```sh
curl -LO https://github.com/Pomodoro-Everywhere/pomodorough-desktop/releases/download/v0.24.0/Pomodorough-0.24.0-x86_64.flatpak
flatpak install --user ./Pomodorough-0.24.0-x86_64.flatpak
