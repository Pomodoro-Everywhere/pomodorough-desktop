...
| --- | --- | --- |
| `wheel` | `pomodorough_linux-0.11.1-py3-none-any.whl` | Linux desktop; `system=Linux`, `machine` matches the recorded host architecture |
| `flatpak` | `Pomodorough-0.11.1-x86_64.flatpak` | Linux x86_64, installed bundle with Secret Service; `system=Linux`, `machine=x86_64` |
| `windows` | `Pomodorough-0.11.1-windows-x86_64.exe` | Windows x86_64 with DPAPI; `system=Windows`, `machine=AMD64` |
